...
export default function ContactUs({ subscription }) {
  const {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form  className="space-y-8">
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-green-400 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
      </form>
  </div>
</section>
<br></br><br></br>
